...
export const proto = {
  ...
  ForgetCameraRequest: goProProto.ForgetCameraRequest,
  ...
  MoveCamerasToGroupRequest: goProProto.MoveCamerasToGroupRequest,
  SetGroupSyncRequest: goProProto.SetGroupSyncRequest,
